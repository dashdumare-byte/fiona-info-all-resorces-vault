...
## Claude Opus 5 (NEW -- June 9, 2026)
Mythos-class, SWE-Bench Pro 80.3%, $10/M input. EXTREME fallback, Ashandy approval. F-GARP Step 4b.

## 3 Supervisors
Claude Code (Opus 4.8 -> Opus 5 (Fable 5 fallback)) | Codex (GPT-5.5) | OpenCode (Qwen3.7 + Nemotron Ultra)
...
## Budget
Build: $300-350 (30 days, $10/day cap) | Runtime: $200-250/month | Opus 5 reserve (Fable 5 fallback): $50-100
...
## F-GARP (8 Steps)
Auto-prompt -> Evidence -> FacTool -> Sub-council -> **Opus 5 (NEW)** -> Quantum -> Executive -> Pause

## Risk Status: ALL CLOSED
R3: F-GARP + Opus 5 (Fable 5 fallback) | R6: MAES | R11: Langfuse + OpenLLMetry + OpenObserve
